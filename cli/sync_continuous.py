...
from app.db.database import init_db, dispose_engine, get_engine
from app.client.okx_client import OKXClient
from app.db.models import Candle
from app.proxy.proxy_pool import build_proxy_pool
...
from app.config.download_scope import load_scope, resolve_instruments, resolve_time_range, scope_default

logger = get_logger("sync_continuous")
