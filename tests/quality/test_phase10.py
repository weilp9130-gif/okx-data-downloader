...
class TestDataConflictDetector(unittest.TestCase):
    ...
    def test_ws_authoritative_policy_skips_conflict(self):
        ...
        from sqlalchemy.dialects.postgresql import insert as pg_insert
        from app.db.models import Trade
        from app.quality.conflict import CONFLICT_POLICY
...
class TestPhase10Models(unittest.TestCase):
    def test_data_conflict_model(self):
        from app.db.models import DataConflict
